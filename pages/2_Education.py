...
c1c1.markdown('<p class="head-font">Boston University</p>', unsafe_allow_html=True)
...
c2c1.markdown('<p class="head-font">Indian Institute of Technology (IIT) Roorkee</p>', unsafe_allow_html=True)
